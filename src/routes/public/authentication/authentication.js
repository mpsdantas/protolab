...
module.exports = (application) => {
    ...
    application.get('/realizar-recuperacao', (req, res) => {
        if(!req.query.token) return res.redirect('/recuperar-senha');
        res.render('public/realizarRecuperacao', {token:req.query.token})});
    application.post('/recuperar-senha', (req, res) => {authenticationController.enviarRecuperarSenha(application, req, res)});
    application.post('/realizar-recuperacao', (req, res) => { authenticationController.mudarSenha(application, req, res)});
