exports.viewStatusProcesso = (application, req, res) => {
    ...
    res.render('dashboard/atualizar-status-processo',{nome, emailUser, tipoUsuario});
};
...
exports.viewRealizarStatusProcesso = (application, req, res) => {
    ...
    res.render('dashboard/realizar-atualizacao-status',{nome, emailUser, tipoUsuario, idProcesso});
};